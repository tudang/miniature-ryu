...
ovs-vsctl add-port br4 ge-1/1/35 vlan_mode=trunk trunks=1,9 -- set Interface ge-1/1/35 type=pica8
ovs-vsctl add-port br4 ge-1/1/36 vlan_mode=trunk trunks=1,9 -- set Interface ge-1/1/36 type=pica8
ovs-vsctl add-port br4 ge-1/1/39 vlan_mode=trunk trunks=1,5 -- set Interface ge-1/1/39 type=pica8
ovs-vsctl add-port br4 ge-1/1/40 vlan_mode=trunk trunks=1,5 -- set Interface ge-1/1/40 type=pica8
