...
ovs-vsctl add-port br3 ge-1/1/33 vlan_mode=trunk trunks=1,8 -- set Interface ge-1/1/33 type=pica8
ovs-vsctl add-port br3 ge-1/1/34 vlan_mode=trunk trunks=1,8 -- set Interface ge-1/1/34 type=pica8
ovs-vsctl add-port br3 ge-1/1/37 vlan_mode=trunk trunks=1,4 -- set Interface ge-1/1/37 type=pica8
ovs-vsctl add-port br3 ge-1/1/38 vlan_mode=trunk trunks=1,4 -- set Interface ge-1/1/38 type=pica8
